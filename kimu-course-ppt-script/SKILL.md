...
description: Convert long Chinese course sources into Kimu-style, page-numbered PPT prompter scripts that can be taught directly. Use when the user asks to turn Word, TXT, Markdown, audio, transcripts, class recordings, or reference courses into PPT文字稿、PPT提词稿、课程逐页文稿，asks to continue the next course chapter, or wants either a 35–45 minute reviewed segment or a full-course conversion.
---
...
Use the selection order from `$kimu-case-bank` instead of copying its records:
